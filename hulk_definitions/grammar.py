...
atom %= atom + dot + idx, lambda h,s: Invoke(s[1], Var(s[3])) #112
...
method_block %= func + idx + opar + arg_list + cpar + expr_block, lambda h,s: Function(s[2], s[4], s[6]) #163
method_block %= func + idx + opar + cpar + expr_block, lambda h,s: Function(s[2], None, s[5]) #164
...
method_block %= func + idx + opar + arg_list + cpar + typed + expr_block, lambda h,s: Function(s[2], s[5], s[7], s[6]) #167
method_block %= func + idx + opar + cpar + typed + expr_block, lambda h,s: Function(s[2], None, s[6], s[5]) #168
