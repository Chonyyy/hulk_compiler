...
protocol, define, def_list = G.NonTerminals('<protocol> <define> <define-list>')
...
let_var_block %= let + var_corpse + inx + if_expr_block, None # Your code here!!! (add rule) 21
let_var_block %= let + var_corpse + inx + let_var_block, None # Your code here!!! (add rule) 22
...
var_corpse %= idx + typed + equal + stat, None # Your code here!!! (add rule) 25
var_corpse %= idx + typed + equal + stat + comma + var_corpse, None # Your code here!!! (add rule) 26
var_corpse %= idx + typed + equal + stat + comma + let + var_corpse, None # Your code here!!! (add rule) 27

def_func %= func + idx + opar + arg_list + cpar + arrow + stat, None # Your code here!!! (add rule) 28
def_func_block %= func + idx + opar + arg_list + cpar + arrow + let_var_block, None # Your code here!!! (add rule) 29
def_func_block %= func + idx + opar + arg_list + cpar + arrow + def_func_block, None # Your code here!!! (add rule) 29
def_func_block %= func + idx + opar + arg_list + cpar + arrow + def_func_block, None # Your code here!!! (add rule) 30
def_func_block %= func + idx + opar + arg_list + cpar + block, None # Your code here!!! (add rule) 31

def_func %= func + idx + opar + arg_list + cpar + typed + arrow + stat, None # Your code here!!! (add rule) 28
def_func_block %= func + idx + opar + arg_list + cpar + typed + arrow + let_var_block, None # Your code here!!! (add rule) 29
def_func_block %= func + idx + opar + arg_list + cpar + typed + arrow + if_expr_block, None # Your code here!!! (add rule) 29
def_func_block %= func + idx + opar + arg_list + cpar + typed + arrow + def_func_block, None # Your code here!!! (add rule) 30
def_func_block %= func + idx + opar + arg_list + cpar + typed + block, None # Your code here!!! (add rule) 31

arg_list %= idx, None # Your code here!!! (add rule) 32
arg_list %= idx + typed, None # Your code here!!! (add rule) 32
arg_list %= idx + comma + arg_list, None # Your code here!!! (add rule) 33
arg_list %= idx + typed + comma + arg_list, None # Your code here!!! (add rule) 33

block %= obracket + stat_list + cbracket, None # Your code here!!! (add rule) 34
block %= obracket + cbracket, None # Your code here!!! (add rule) 34

if_expr %= ifx + opar + expr + cpar + stat + elsex + stat, None # Your code here!!! (add rule) 35
if_expr %= ifx +  opar + expr + cpar + block + elsex + stat, None # Your code here!!! (add rule) 36
if_expr %= ifx + opar + expr + cpar + let_var_block + elsex + stat, None # Your code here!!! (add rule) 37
if_expr %= ifx + opar + expr + cpar + def_func_block + elsex + stat, None # Your code here!!! (add rule) 38

if_expr %= ifx + opar + expr + cpar + stat + if_br + elsex + stat, None # Your code here!!! (add rule) 35
if_expr %= ifx +  opar + expr + cpar + block + if_br + elsex + stat, None # Your code here!!! (add rule) 36
if_expr %= ifx + opar + expr + cpar + let_var_block + if_br + elsex + stat, None # Your code here!!! (add rule) 37
if_expr %= ifx + opar + expr + cpar + def_func_block + if_br + elsex + stat, None # Your code here!!! (add rule) 38

if_expr_block %= ifx + opar + expr + cpar + stat + elsex + def_func_block, None # Your code here!!! (add rule) 35
if_expr_block %= ifx +  opar + expr + cpar + block + elsex + def_func_block, None # Your code here!!! (add rule) 36
if_expr_block %= ifx + opar + expr + cpar + let_var_block + elsex + def_func_block, None # Your code here!!! (add rule) 37
if_expr_block %= ifx + opar + expr + cpar + def_func_block + elsex + def_func_block, None # Your code here!!! (add rule) 38

if_expr_block %= ifx + opar + expr + cpar + stat + elsex + let_var_block, None # Your code here!!! (add rule) 35
if_expr_block %= ifx +  opar + expr + cpar + block + elsex + let_var_block, None # Your code here!!! (add rule) 36
if_expr_block %= ifx + opar + expr + cpar + let_var_block + elsex + let_var_block, None # Your code here!!! (add rule) 37
if_expr_block %= ifx + opar + expr + cpar + def_func_block + elsex + let_var_block, None # Your code here!!! (add rule) 38

if_expr_block %= ifx + opar + expr + cpar + stat + elsex + block, None # Your code here!!! (add rule) 35
if_expr_block %= ifx +  opar + expr + cpar + block + elsex + block, None # Your code here!!! (add rule) 36
if_expr_block %= ifx + opar + expr + cpar + let_var_block + elsex + block, None # Your code here!!! (add rule) 37
if_expr_block %= ifx + opar + expr + cpar + def_func_block + elsex + block, None # Your code here!!! (add rule) 38

if_expr_block %= ifx + opar + expr + cpar + stat + if_br + elsex + def_func_block, None # Your code here!!! (add rule) 35
if_expr_block %= ifx +  opar + expr + cpar + block + if_br + elsex + def_func_block, None # Your code here!!! (add rule) 36
if_expr_block %= ifx + opar + expr + cpar + let_var_block + if_br + elsex + def_func_block, None # Your code here!!! (add rule) 37
if_expr_block %= ifx + opar + expr + cpar + def_func_block + if_br + elsex + def_func_block, None # Your code here!!! (add rule) 38

if_expr_block %= ifx + opar + expr + cpar + stat + if_br + elsex + let_var_block, None # Your code here!!! (add rule) 35
if_expr_block %= ifx +  opar + expr + cpar + block + if_br + elsex + let_var_block, None # Your code here!!! (add rule) 36
if_expr_block %= ifx + opar + expr + cpar + let_var_block + if_br + elsex + let_var_block, None # Your code here!!! (add rule) 37
if_expr_block %= ifx + opar + expr + cpar + def_func_block + if_br + elsex + let_var_block, None # Your code here!!! (add rule) 38

if_expr_block %= ifx + opar + expr + cpar + stat + if_br + elsex + block, None # Your code here!!! (add rule) 35
if_expr_block %= ifx +  opar + expr + cpar + block + if_br + elsex + block, None # Your code here!!! (add rule) 36
if_expr_block %= ifx + opar + expr + cpar + let_var_block + if_br + elsex + block, None # Your code here!!! (add rule) 37
if_expr_block %= ifx + opar + expr + cpar + def_func_block + if_br + elsex + block, None # Your code here!!! (add rule) 38

if_br %= elifx + opar + expr + cpar + stat, None # Your code here!!! (add rule) 43
if_br %= elifx + opar + expr + cpar + block, None # Your code here!!! (add rule) 44
if_br %= elifx + opar + expr + cpar + let_var_block, None # Your code here!!! (add rule) 45
if_br %= elifx + opar + expr + cpar + def_func_block, None # Your code here!!! (add rule) 46
...
atom %= atom + asx + idx, None # Your code here!!! (add rule) 72
atom %= atom + asx + strx, None # Your code here!!! (add rule) 72
atom %= atom + asx + numx, None # Your code here!!! (add rule) 72
atom %= atom + asx + objx, None # Your code here!!! (add rule) 72
atom %= atom + asx + boolx, None # Your code here!!! (add rule) 72
...
built_in %= randx + opar + cpar, None # Your code here!!! (add rule) 82
...
while_expr_block %= whilex + opar + expr + cpar + if_expr_block, None # Your code here!!! (add rule) 96
...
for_expr_block %= forx + opar + idx + inx + expr + cpar + if_expr_block, None # Your code here!!! (add rule) 100
...
def_func_block %= func + idx + opar + arg_list + cpar + typed + while_expr_block, None # Your code here!!! (add rule) 110
def_func_block %= func + idx + opar + arg_list + cpar + typed + for_expr_block, None # Your code here!!! (add rule) 111
...
def_func %= func + idx + opar + arg_list + cpar + typed + arrow + while_expr_block, None # Your code here!!! (add rule) 112
def_func %= func + idx + opar + arg_list + cpar + typed + arrow + for_expr_block, None # Your code here!!! (add rule) 113
...
prop %= idx + typed + equal + atom, None # Your code here!!! (add rule)
...
method %= idx + opar + arg_list + cpar + block, None # Your code here!!! (add rule)
method %= idx + opar + cpar + block, None # Your code here!!! (add rule)

method %= idx + opar + arg_list + cpar + typed + arrow + stat, None # Your code here!!! (add rule)
method %= idx + opar + cpar + typed + arrow + stat, None # Your code here!!! (add rule)
method %= idx + opar + arg_list + cpar + typed + block, None # Your code here!!! (add rule)
method %= idx + opar + cpar + typed + block, None # Your code here!!! (add rule)
...
typed %= colon + idx, None # Your code here!!! (add rule)
typed %= colon + strx, None # Your code here!!! (add rule)
typed %= colon + numx, None # Your code here!!! (add rule)
typed %= colon + objx, None # Your code here!!! (add rule)
typed %= colon + boolx, None # Your code here!!! (add rule) 

protocol %= proto + idx + obracket + def_list + cbracket, None # Your code here!!! (add rule)
protocol %= proto + idx + extends + idx + obracket + def_list + cbracket, None # Your code here!!! (add rule)

def_list %= define + semi, None # Your code here!!! (add rule)
def_list %= define + semi + def_list, None # Your code here!!! (add rule)

define %= idx + opar + cpar, None # Your code here!!! (add rule)
define %= idx + opar + arg_list + cpar, None # Your code here!!! (add rule)
define %= idx + opar + cpar + typed, None # Your code here!!! (add rule)
define %= idx + opar + arg_list + cpar + typed, None # Your code here!!! (add rule)

stat_list %= protocol, None # Your code here!!! (add rule)
stat_list %= protocol + stat_list, None # Your code here!!! (add rule)
